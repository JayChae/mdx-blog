...
![](https://github.com/user-attachments/assets/edecd65b-7af9-4573-b503-4b56939a2293)

## 트랜잭션 생성

트랜잭션을 생성하는 과정은 이전과 동일합니다. 단지, 이번에는 바로 블록을 채굴해서 추가하지 않고, 생성된 트랜잭션을 mempool에 추가합니다
...
### 1. 이전에 본 적 없는 트랜잭션을 받으면, 전체 mempool를 모든 피어에게 전파한다.

![](https://github.com/user-attachments/assets/d9b83643-7cf9-46e2-b407-cd9cb433dcfe)

### 2. 노드가 다른 노드에 처음 연결될 때, 상대 노드의 mempool를 요청(query)한다.

![](https://github.com/user-attachments/assets/113d06ce-d28e-4c85-82bb-30416141762c)
...
### 트랜잭션의 인풋 중 하나라도 이미 기존 mempool에 존재한다면 그 트랜잭션은 풀에 추가될 수 없다.
...
![](https://github.com/user-attachments/assets/f4752032-82eb-4cb2-ae41-49be9d9a311a)
...
![](https://github.com/user-attachments/assets/912b9a48-6e45-4e87-9589-02da7e8c7725)

## 다음 챕터

이제 simple-coin을 더 쉽게 다룰 수 있도록 위해 도커를 설정하고 SPA 웹을 제작하겠습니다.
